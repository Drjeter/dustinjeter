        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="space-y-6 text-slate-600 text-lg leading-relaxed font-light">
              <p>
                In a digital world full of noise, I build websites that act as a sanctuary for your clients. I specialize in bespoke digital experiences that prioritize speed, accessibility, and human-centered design.
              </p>
              <p>
